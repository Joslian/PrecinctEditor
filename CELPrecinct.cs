...
namespace PrecinctEditor
{
    public class CELPrecinct
    {
        public override string ToString() {
            return string.Format("{0}", "Precinct");
        }
        ...
        public ObservableCollection<VECTOR3> m_aPoints { get; set; }
        ...
        public CELPrecinct(BinaryReader br) {
            ...
            m_aPoints = new ObservableCollection<VECTOR3>();
        ...
        public CELPrecinct Clone() {
            using (MemoryStream ms = new MemoryStream()) {
                using (BinaryReader br = new BinaryReader(ms)) {
                    using (BinaryWriter bw = new BinaryWriter(ms)) {
                        Write(bw);
                        br.BaseStream.Seek(0, SeekOrigin.Begin);
                        return new CELPrecinct(br);
                    }
                }
            }
        }
